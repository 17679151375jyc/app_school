<template>
  <div class="page_box_css">
    <headerModu :title="'忘记密码'" :Isright="false" />
    <popupModu 
        :IsShow='IsShow' 
        :titleText="'验证'"
        :butShow='false'
    ...
    <div class="dis_column_center_center land_css">
      ...
      <ul>
        ...
        <li class="dis_row_around_center li_css">
          <span class="span_lable_css">新密码</span>
          <cube-input
      ...
      <cube-button :active="true" class="success_but_css" style="margin-top:6vw">确认</cube-button>
    </div>
  </div>
</template>
